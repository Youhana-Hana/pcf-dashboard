...
describe('Environments', () => {
  ...
  it('should render environemnts header', () => {
    ...
    expect(label).toEqual('<h1 class=\"mb-0\">Environments<div class=\"align-bottom float-right\"><div class=\"sweet-loading col-centered\"><div class=\"css-13qlqsl\"><div class=\"css-6ny95\"></div><div class=\"css-12pmby4\"></div></div></div></div></h1>');
  })
